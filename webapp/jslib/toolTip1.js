			 ...
			 handle=setTimeout(function(){		    		       			       			    			  	   
				 $.getJSON(ctx+"/pages/jsontemp/"+textJson,function(data){ 
					 ...
					 $.each(data1,function(infoIndex,info){ 
	                     ...
	                     var dimension=info["dimension"]==undefined?"":"<span style='color:#0287D0'>"+title[0]+":</span>"+info["dimension"]+"<br/>";
	                     var calculation=info["calculation"]==undefined?"":"<span style='color:#0287D0'>"+title[1]+":</span>"+info["calculation"]+"<br/>";
	                     var area=info["area"]==undefined?"":"<span style='color:#0287D0'>"+title[2]+":</span>"+info["area"]+"</p>";
